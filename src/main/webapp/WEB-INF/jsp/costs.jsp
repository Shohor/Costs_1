        ...
        <div class="shadow">
            ...
            <div class="view-box">
                ...
                <table class="table table-striped display" id="datatable">
                    <thead>
                    <tr>
                        <th><fmt:message key="costs.group"/></th>
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="group" class="control-label col-xs-3"><fmt:message key="costs.group"/></label>

                        <div class="col-xs-9">
                            <select class="btn btn-default" id="group">
                                <c:forEach items="${groupList}" var="group">
                                    <jsp:useBean id="group" scope="page" type="de.shokhor.costs.model.Group"/>
                                    <option name="groupId" value="${group.id}">${group.group}</option>
                                </c:forEach>
                                <input type="text" hidden="hidden" id="groupId" name="groupId" value="${group.id}">
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="email" class="form-control" id="description" name="description" placeholder="<fmt:message key="costs.description"/>">
                        </div>
                    </div>
