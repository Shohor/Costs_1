...
INSERT INTO type_cost (user_id, type) VALUES
  (1,'Food'),
  (1,'Children'),
  (2,'House'),
  (1,'Presents'),
...
INSERT INTO cash_accounts_and_cards (amount, description, user_id) VALUES
  (2000,"",1),
  (5000,"",1),
  (2854,"",2);
...
INSERT INTO income (amount, description, date, cash_accounts_and_cards_id, periodicity_id, user_id,type_income_id) VALUES
  (250,'','2017-01-01 10:00:00',2,3,1,1),
  (550,'','2017-01-02 10:00:00',2,3,1,3),
  (100,'','2017-01-01 10:00:00',1,NULL,1,2);